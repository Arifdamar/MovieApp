    ...
    public static class Repository
    {
        ...
        static Repository()
        {
            _movies = new List<Movie>()
            {
                ...
                new Movie(){ Id=5, Name = "Spider-Man: Far from Home", Description="Following the events of Avengers: Endgame (2019), Spider-Man must step up to take on new threats in a world that has changed forever.", ImageUrl="Spider-Man_Far from Home.jpg"}
            };
        }
